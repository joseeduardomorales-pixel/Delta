...
function buildSystemPrompt({ profile }) {
  return [
    ...
    '   This is the FAST PATH: opens + adds item + completes + closes in one shot.',
    '',
    ...
    '  { needs_meter: true, meter_unit, last_known }. When you see this:',
    '   a. Ask the user "What\'s the current odometer/hour meter on {unit}?"',
    '      (Mention the last known value for context if useful.)',
